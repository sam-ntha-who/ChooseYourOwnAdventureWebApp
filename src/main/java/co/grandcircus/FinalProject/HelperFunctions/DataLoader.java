...
// this does not work as it wants storyRepo and sceneRepo to be static objects - when they are static objects they are null. 
// if the method isn't static, the controller isn't interested in calling the method
// surely there is a way around this but unsure of how to get there at the moment
