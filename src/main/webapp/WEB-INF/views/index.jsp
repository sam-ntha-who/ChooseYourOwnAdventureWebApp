...
<body>
	...
	<br>
	<br>
	<div class="banner">Choose Your Own Adventure</div>
	<br>
		...
		<tbody>
			...
			<c:forEach items="${storyList}" var="story" varStatus="status">
				<tr>
					...
					<td>${story.title}</td>
					<td><a href="play?id=${story.startingSceneId}"><button
								type="button" class="button-primary">Play / Edit</button></a></td>
					<td><a href="deleteStory?id=${story.id}"
